    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=50, unique=True, validators=[django.core.validators.EmailValidator(message='Invalid Email')], verbose_name='Email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_counter', models.PositiveIntegerField(default=0, editable=False, verbose_name='Like Counter')),
                ('header_link', models.FileField(blank=True, default='site/default_logo.png', null=True, upload_to='user', verbose_name='Header Cover')),
                ('artist', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profile', to='core.artist')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='artist',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='artist', to='core.user'),
        ),
    ]
