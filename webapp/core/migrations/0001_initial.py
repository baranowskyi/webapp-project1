    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_link', models.ImageField(blank=True, default='media/site/default_logo.png', upload_to=core.service_functions.services.get_avatar_upload_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'png', 'gif']), core.service_functions.services.validate_size_avatar], verbose_name='Avatar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header_link', models.FileField(blank=True, default='site/default_background.jpg', null=True, upload_to=core.service_functions.services.get_profile_background_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'png', 'gif']), core.service_functions.services.validate_size_profile_background], verbose_name='Header Cover')),
