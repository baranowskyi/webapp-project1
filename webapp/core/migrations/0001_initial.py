    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_url', models.URLField(blank=True, unique=True, verbose_name='Profile URL')),
                ('avatar_link', models.FileField(blank=True, null=True, upload_to=core.service_functions.services.get_avatar_upload_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'png', 'gif']), core.service_functions.services.validate_size_avatar], verbose_name='Avatar')),
                ('header_link', models.FileField(blank=True, null=True, upload_to=core.service_functions.services.get_profile_background_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'png', 'gif']), core.service_functions.services.validate_size_profile_background], verbose_name='Header Cover')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_link', models.FileField(upload_to=core.service_functions.services.get_track_upload_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp3', 'wav']), core.service_functions.services.validate_size_track], verbose_name='File')),
                ('cover_link', models.FileField(blank=True, default='site/logo_artist.png', null=True, upload_to='user', verbose_name='Cover')),
